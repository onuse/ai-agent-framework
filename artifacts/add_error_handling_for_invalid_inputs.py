"""
Task: Add Error Handling for Invalid Inputs
Description: Modify existing code to handle cases where users input invalid data (e.g., non-numeric values, division by zero).
...
class Calculator:
    ...
    def handle_invalid_input(self, value):
        """
        ...
        Returns:
            None
        """
        logging.error(f"Invalid input: {value}. Please enter a valid number.")
        return None
...
if __name__ == "__main__":
    ...
    print(calc.add('a', 5))  # Output: Invalid input type. Please enter numbers only.
    print(calc.subtract(10, 'b'))  # Output: Invalid input type. Please enter numbers only.
    print(calc.multiply(10, 'c'))  # Output: Invalid input type. Please enter numbers only.
